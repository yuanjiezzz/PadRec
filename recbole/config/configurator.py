...
class Config(object):
    ...
    def __init__(
        ...
        num_interactions_to_add=None, noise_scale=None, noise_min=None, noise_max=None, update_noise=False,
    ):
        """
        Args:
        ...
        self.num_interactions_to_add = num_interactions_to_add
    ...
    def _get_final_config_dict(self):
        ...
        if self.num_interactions_to_add is not None:
            final_config_dict['num_interactions_to_add'] = self.num_interactions_to_add

        if self.noise_scale is not None:
            final_config_dict['noise_scale'] = self.noise_scale

        if self.noise_min is not None:
            final_config_dict['noise_min'] = self.noise_min

        if self.noise_max is not None:
            final_config_dict['noise_max'] = self.noise_max
        
        final_config_dict['update_noise'] = self.update_noise

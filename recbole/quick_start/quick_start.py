...
def run(
    ...
    if nproc == 1 and world_size <= 0:
        res = run_recbole(
            ...
            saved=saved,
            num_interactions_to_add=num_interactions_to_add,
...
def run_recbole(
    ...
    best_valid_score, best_valid_result = trainer.fit(
        train_data, valid_data, saved=saved, show_progress=config["show_progress"], dataset=dataset
    )
